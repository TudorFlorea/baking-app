...
public class IngredientsWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            String recipeName = SharedPreferencesUtils.getStringFromSharedPrefsForKey(Constants.SHARED_PREF_CURRENT_RECIPE_NAME_KEY, context);

            views.setTextViewText(R.id.ingredient_name_widget, recipeName);
